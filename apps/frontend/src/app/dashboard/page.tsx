...
const Dashboard = () => {
  ...
  return (
    ...
    >
          ...
          <div className="backdrop-blur-xl bg-white/40 dark:bg-black/40 border-2 border-white/50 dark:border-white/10 p-6 rounded-[2rem] mb-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-teal-100 dark:bg-teal-900/30 rounded-2xl flex items-center justify-center shadow-lg">
                  <Grid3X3 className="text-teal-500" size={24} />
                </div>
                <div>
      ...
      {/* Footer */}
      <footer className="px-8 py-6 flex justify-between items-end relative z-10">
